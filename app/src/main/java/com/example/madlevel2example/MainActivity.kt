...
class MainActivity : AppCompatActivity() {
    ...
    private fun addReminder(reminder: String){
        if (reminder.isNotBlank()) {
            ...
            binding.etReminder.text?.clear() // Clear the edit text after adding the reminder
        } else {
            // Snackbar message instead of Toast
